...
/** Convert dollars to integer cents for DB / reconciliation. */
export function paymentQrDollarsToCents(dollars) {
  return Math.round(dollars * 100);
}

/** Format integer cents for form display (e.g. 19620 → "196.20"). */
export function formatPaymentQrCentsForInput(cents) {
...
/** Convert integer cents to decimal SGD for paynowqr (e.g. 19620 → 196.2). */
export function paymentQrCentsToPaynowAmount(cents) {
